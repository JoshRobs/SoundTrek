...
<template>
  <li class="track-row">
    ...
    <div class="info">
      ...
      <span class="meta">{{ soundtrack.composer }} · {{ soundtrack.console }} · {{ soundtrack.release_year }}</span>
    </div>
...
.track-row {
  display: grid;
  grid-template-columns: 2.5rem 48px 1fr auto auto;
  align-items: center;
  gap: 1rem;
...
.cover-fallback { font-size: 1.3rem; }
